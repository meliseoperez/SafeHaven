...
public class Zona {
     ...
     *
     */
    public Zona(List<LatLng> coordenadas,String color) {
    ...
    public void dibujarZona(GoogleMap mapa) {
        // Convertir el nombre del color en valor de color.
        ...
        polygonOptions.fillColor(fillColor); // Color de relleno del polígono.
        polygonOptions.strokeWidth(5); // Ancho del borde del polígono.

        // Obtener un manejador para el hilo principal.
        Handler handler = new Handler(Looper.getMainLooper());

        // Crear un ejecutable que agregará el polígono al mapa.
        ...
        // Publicar el ejecutable en el hilo principal.
